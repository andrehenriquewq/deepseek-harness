...
import { gitStateResolveRequestSchema } from '../api/git-state.schema.ts'
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'gitState.resolve': { schema: gitStateResolveRequestSchema, invoke: (api, r) => api.gitState.resolve(r) },
