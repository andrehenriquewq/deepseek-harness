...
- button "Bash ls packages && echo \"---\" && find packages -maxdepth 2 -type d":
  - img
  - img
  - text: Bash ls packages && echo "---" && find packages -maxdepth 2 -type d
- button "Think There are 4 packages:":
  - img
  - img
  - text: "Think There are 4 packages:"
- 'button "Failed Bash find packages -maxdepth 2 -mindepth 2 -type d | sort | awk ''{print NR\": \"$0}'' && echo \"---random pick---\" && find packages -maxdepth 2 -mindepth 2 -type d | sort | PATH=/__dsh_fixture_missing__ shuf -n 1"':
  - img
  - text: "Failed Bash find packages -maxdepth 2 -mindepth 2 -type d | sort | awk '{print NR\": \"$0}' && echo \"---random pick---\" && find packages -maxdepth 2 -mindepth 2 -type d | sort | PATH=/__dsh_fixture_missing__ shuf -n 1"
...
- button "Bash find packages -maxdepth 2 -mindepth 2 -type d | sort > /tmp/pkglist.txt && python3 -c \"":
  - img
  - img
  - text: Bash find packages -maxdepth 2 -mindepth 2 -type d | sort > /tmp/pkglist.txt && python3 -c "
...
- button "Bash find packages/context/session-reference -type f -not -path '*/node_modules/*' -not -path '*/.git/*' | sort":
  - img
  - img
  - text: Bash find packages/context/session-reference -type f -not -path '*/node_modules/*' -not -path '*/.git/*' | sort
...
- button "Bash python3 -c \"":
  - img
  - img
  - text: Bash python3 -c "
- button "Bash find packages/llm/token-meter -type f -not -path '*/node_modules/*' -not -path '*/.git/*' | sort":
  - img
  - img
  - text: Bash find packages/llm/token-meter -type f -not -path '*/node_modules/*' -not -path '*/.git/*' | sort
