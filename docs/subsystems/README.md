...
| [git.md](git.md) | the Git repository-state seam: the four determinate states, request/spec resolution, reference-counted observation, and the read-only guarantee |
