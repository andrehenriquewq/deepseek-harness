...
| `ctx.gitState` | `seam` | [`git-state`](../packages/git/git-state) | [`git-state-local`](../packages/git/git-state-local) | `apiproxy` | - | Resolution delegates to the git binary; the apiproxy tracks live session cwd values and pushes host frames, and the header chip consumes them. |
...
| `ctx.web` | `seam` | [`web`](../packages/web/web) | [`web-search-exa`](../packages/web/web-search-exa), [`web-search-perplexity`](../packages/web/web-search-perplexity), [`web-search-deepseek`](../packages/web/web-search-deepseek), [`web-search-antigravity`](../packages/web/web-search-antigravity), [`web-fetch-http`](../packages/web/web-fetch-http) | [`tool-web`](../packages/web/tool-web) | - | Search and fetch providers register into one ctx.web seam; tool-web owns the stable model-facing names. |
