...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  GitDetachedHead: 'git.md',
  GitNamedBranch: 'git.md',
  GitNoRepository: 'git.md',
  GitRepositoryState: 'git.md',
  GitStateObserver: 'git.md',
  GitStateRequest: 'git.md',
  GitStateSpec: 'git.md',
  GitUnavailable: 'git.md',
